...
<head>
    ...
    <link href="<?php echo base_url(); ?>css/checkboxes/style.css" rel="stylesheet" type="text/css" >
    <link rel="stylesheet"
    ...
    <script src="<?php echo base_url(); ?>js/jquery.easydropdown.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/bower_components/jquery/jquery.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/bower_components/moment/min/moment.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/bower_components/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
