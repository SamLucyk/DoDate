<div class="col-md-12" id="neighborhood">
    ...
    <div class="col-md-10 left">
        ...
        <label for="cc7" class="css-label med elegant">West Village</label><br>
        <input type="checkbox" id="cc8" class="css-checkbox med"/>
        <label for="cc8" class="css-label med elegant">Greenwich Village</label><br>
        <input type="checkbox" id="cc9" class="css-checkbox med"/>
        <label for="cc9" class="css-label med elegant">Noho</label>
    </div>
</div>